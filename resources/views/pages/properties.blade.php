...
<div class="container py-5">
    ...
    <div class="text-primary mb-5 text-center">
        <h1 class="fw-bold">All Properties</h1>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100 border-0 shadow-sm rounded-4">
                ...
                {{-- IMAGE --}}
                <img
                    src="{{ $item->photo ?? 'https://via.placeholder.com/400x250' }}"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-3 text-muted small mb-3">
                        <span>🛏{{ number_format ($item->bed_room, 0) }} Beds</span>
                        <span>🛁 {{ number_format ($item->bath_room, 0)}} Baths</span>
                        <span>📐{{ number_format ($item->area_l, 0, ',', '.') }} m²</span>
                    </div>
                ...
                <div class="card-footer bg-white border-0">
                    <a
                        href="{{ route('property.show', $item->property_id) }}"
